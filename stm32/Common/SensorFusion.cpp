...
{	
	float q1 = m_RotQuat.w, q2 = m_RotQuat.x, q3 = m_RotQuat.y, q4 = m_RotQuat.z;   // short name local variable for readability
            ...
            qDot1 = 0.5f * (-q2 * gx - q3 * gy - q4 * gz) - SF_Beta * s1;
            qDot2 = 0.5f * (q1 * gx + q3 * gz - q4 * gy) - SF_Beta * s2;
            qDot3 = 0.5f * (q1 * gy - q2 * gz + q4 * gx) - SF_Beta * s3;
            qDot4 = 0.5f * (q1 * gz + q2 * gy - q3 * gx) - SF_Beta * s4;
