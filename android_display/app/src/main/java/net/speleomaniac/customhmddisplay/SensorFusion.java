...
public class SensorFusion {
    ...
    public SensorFusion(float beta)
    {
        m_Beta = beta;
        //exInt = eyInt = ezInt = 0.0f;
        m_RotQuat = new Quaternion(1, 0, 0, 0);
    }
    ...
    {
        float q0 = m_RotQuat.w, q1 = m_RotQuat.x, q2 = m_RotQuat.y, q3 = m_RotQuat.z;   // short name local variable for readability
        float recipNorm;
        float s0, s1, s2, s3;
        ...
        m_RotQuat.w = q0 * recipNorm;
        m_RotQuat.x = q1 * recipNorm;
        m_RotQuat.y = q2 * recipNorm;
        m_RotQuat.z = q3 * recipNorm;
    }
